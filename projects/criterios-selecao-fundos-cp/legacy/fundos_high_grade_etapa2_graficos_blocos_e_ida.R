...
arquivo_entrada <- "fundos_retornos_etapa1_36m.rds"
...
write_rds(
  fundos_mensais,
  "fundos_mensais_etapa2_36m.rds"
)

write_excel_csv2(
  fundos_mensais,
  "fundos_mensais_etapa2_36m.csv"
)
...
write_excel_csv2(
  resumo_correlacao,
  "resumo_correlacao_fundos_36m.csv"
)
...
write_excel_csv2(
  ...
  "matriz_correlacao_excessos_mensais_36m.csv"
)
...
write_excel_csv2(
  ...
  "metricas_consistencia_risco_36m.csv"
)
...
ggsave(
  filename =
    "grafico_consistencia_vs_excesso_36m.png",
...
write_excel_csv2(
  ...
  "afinidade_benchmarks_36m.csv"
)

write_excel_csv2(
  resumo_benchmark_proximo,
  "resumo_benchmark_proximo_36m.csv"
)
...
write_excel_csv2(
  ...
  "metricas_todos_fundos_36m.csv"
)

write_rds(
  metricas_todos_fundos,
  "metricas_todos_fundos_36m.rds"
)
...
write_excel_csv2(
  ranking_fundos,
  "ranking_fundos_etapa2_36m.csv"
)

write_rds(
  ranking_fundos,
  "ranking_fundos_etapa2_36m.rds"
)
...
config_blocos <- tribble(
  ...
  "score_retorno",         "Score de retorno",         "Excesso anualizado sobre o CDI",                       "grafico_score_retorno_36m.png",
  "score_consistencia",    "Score de consistência",    "Hit rates mensal e em janelas móveis de 6 e 36 meses", "grafico_score_consistencia_36m.png",
  "score_risco",           "Score de risco",           "Drawdown, cauda negativa e volatilidade do excesso",   "grafico_score_risco_36m.png",
  "score_custo",           "Score de custo",           "Taxa de administração e eficiência do custo",          "grafico_score_custo_36m.png",
  "score_diferenciacao",   "Score de diferenciação",   "Correlação média e máxima com os demais fundos",        "grafico_score_diferenciacao_36m.png"
)
...
write_excel_csv2(
  base_retorno_acumulado,
  "base_retorno_acumulado_vs_ida_36m.csv"
)
...
arquivo_xlsx_saida <-
  "analise_high_grade_etapa2_36m.xlsx"
...
write_excel_csv2(
  resumo_etapa2,
  "resumo_etapa2_36m.csv"
)

write_rds(
  resumo_etapa2,
  "resumo_etapa2_36m.rds"
)
