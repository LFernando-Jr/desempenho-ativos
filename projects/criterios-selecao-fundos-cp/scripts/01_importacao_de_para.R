...
arquivo_xlsx   <- "data/input/analise_quantitativa_fundos_high_grade.xlsx"
arquivo_fundos <- "data/input/funds_hist.csv"
arquivo_benchs <- "data/input/benchs_hist.csv"
...
write_excel_csv2(
  de_para,
  "data/config/de_para_fundos_revisao.csv"
)
